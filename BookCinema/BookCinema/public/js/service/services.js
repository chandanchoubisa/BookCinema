movieStubApp = angular.module('movieStubApp', ['ngResource', 'ngRoute', 'firebase', 'angular-loading-bar']);
...
movieStubApp.factory('UserDetail', function() {
...
movieStubApp.factory('seatsManager', SeatsFactory);
